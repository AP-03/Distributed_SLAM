...
- `dataset_ground_truth`: converts raw PhaseSpace rigids into canonical
  ground-truth topics under `/gt/<robot_id>/*`.
...
2. Confirm the mocap rigid-body ID for the robot.
...
- PhaseSpace publishes stamped `/phasespace/rigids`.
